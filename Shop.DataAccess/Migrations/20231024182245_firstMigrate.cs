    ...
    public partial class firstMigrate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DiscountedProductsProductId = table.Column<int>(type: "int", nullable: false),
                    UsersUserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductUser", x => new { x.DiscountedProductsProductId, x.UsersUserId });
                    table.ForeignKey(
                        name: "FK_ProductUser_Products_DiscountedProductsProductId",
                        column: x => x.DiscountedProductsProductId,
